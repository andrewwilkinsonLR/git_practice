...
## Sales Network: Mirror Real-World Organizational Hierarchies

(Screenshot: Show Organizational Structure - maybe three tiers, Company, Regional Level, Sub-Regional Level)

By organizing its sales network and accounts exactly as in the real world, it is easier for sales team members to navigate online in Liferay Commerce, and things are set up for the next step.

## Sales Network: Define Account Access With Organizational Roles and Permissions
...
## Sales Network: Manage Long-Term Access With Organizational Membership
